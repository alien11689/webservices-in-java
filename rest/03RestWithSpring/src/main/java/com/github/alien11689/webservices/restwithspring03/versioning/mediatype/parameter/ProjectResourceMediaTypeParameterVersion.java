...
public class ProjectResourceMediaTypeParameterVersion {
    ...
    @GET
    @Produces("application/vnd.com.github.alien11689+json; version=1")
    ...
    @GET
    @Produces("application/vnd.com.github.alien11689+json; version=2")
